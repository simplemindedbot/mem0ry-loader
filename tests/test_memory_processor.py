...
class TestMemoryProcessor:
    ...
    def test_remove_duplicates(self):
        ...
        memories = [
            ...
            ExtractedMemory("User likes python", "preference", 0.8, "context2"),  # Duplicate (case insensitive)
    ...
    def test_normalize_content(self):
        ...
        assert processor._normalize_content("  multiple   spaces  ") == "multiple spaces"
        
        # Test punctuation stripping
        assert processor._normalize_content('"quoted text"') == "quoted text"
        assert processor._normalize_content("text with punctuation!") == "text with punctuation"
    ...
    def test_clean_content(self):
        ...
        # Test prefix removal
        assert processor._clean_content("Remember: User likes coffee") == "User likes coffee"
        assert processor._clean_content("User preference: Working at night") == "Working at night"
    ...
    def test_are_similar_memories_same_category(self):
        ...
        memory1 = ExtractedMemory("User likes Python programming", "preference", 0.9, "context1")
        memory2 = ExtractedMemory("User enjoys Python development", "preference", 0.8, "context2")
        memory3 = ExtractedMemory("User dislikes meetings", "preference", 0.9, "context3")
        
        # Similar memories
        assert processor._are_similar_memories(memory1, memory2) == True
        
        # Different memories in same category
        assert processor._are_similar_memories(memory1, memory3) == False
    ...
    def test_are_similar_memories_different_category(self):
        ...
        assert processor._are_similar_memories(memory1, memory2) == False
    ...
    def test_merge_memory_group(self):
        ...
        memories = [
            ...
            ExtractedMemory("User enjoys Python programming", "preference", 0.8, "context2", {"source": "conv2"}),
            ExtractedMemory("User prefers Python development", "preference", 0.85, "context3", {"source": "conv1"}),
        ]
    ...
    def test_merge_within_category(self):
        ...
        memories = [
            ExtractedMemory("User likes Python programming", "preference", 0.9, "context1"),
            ExtractedMemory("User enjoys Python development", "preference", 0.8, "context2"),
    ...
    def test_merge_similar_memories(self):
        ...
        memories = [
            ...
            ExtractedMemory("User works as software engineer", "fact", 0.85, "context4"),
        ]
    ...
    def test_process_memories_complete_pipeline(self, sample_memories: List[Dict[str, Any]]):
    ...
    def test_combine_memory_content_simple(self):
        ...
        memories = [
            ExtractedMemory("User likes Python", "preference", 0.9, "context1"),
            ExtractedMemory("User enjoys Python programming", "preference", 0.8, "context2"),
        ]
